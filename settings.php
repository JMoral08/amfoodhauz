        ...
        <div class="container-fluid mt-5">
            <div class="row">
                <div class="col-sm-12 col-lg-12">
                    <div class="card mb-2">
                        <div class="card-body">
                            <a href="settings-product.php"><h4 class="fw-bold text-uppercase text-muted">product</h4></a>
                        </div>
                    </div>
                    <div class="card mb-2">
                        <div class="card-body">
                            <a href="settings-people.php"><h4 class="fw-bold text-uppercase text-muted">people</h4></a>
                        </div>
                    </div>
                    <div class="card mb-2">
                        <div class="card-body">
                            <a href="settings-expenses.php"><h4 class="fw-bold text-uppercase text-muted">expenses</h4></a>
                        </div>
                    </div>
                    <div class="card mb-2">
                        <div class="card-body">
                            <a href="settings-liabilities.php"><h4 class="fw-bold text-uppercase text-muted">liabilities</h4></a>
                        </div>
                    </div>
                </div>
            </div>
