...
<body class="app-body">
    ...
    <ul class="sidebar">
            ...
            <li class="side-link">
                <a class="side-item active" href="expenses.php"><i class="bi bi-graph-up-arrow"></i> Expenses</a>
            </li>
            <li class="side-link">
        ...
        <div class="container-fluid mt-5">
            <div class="row">
                <div class="col-sm-12 col-lg-12">
                    <div class="card mb-3">
                        <div class="card-body">
                            <form action="post" id="form-expenses">
                                <div class="row">
                                    <div class="col-sm-4 col-lg-4 mb-3">
                                        <label class="form-label">Product Description</label>
                                        <textarea type="text" class="form-control" id="txt-product-description"></textarea>
                                    </div>
                                    <div class="col-sm-2 col-lg-2 mb-3">
                                        <label class="form-label">Amount of Purchase</label>
                                        <input type="number" name="text" class="form-control" id="txt-product-amount">
                                    </div>
                        ...
                        <div class="card-footer">
                            <button type="button" class="btn btn-success btn-md" id="btn-product-add"><i class="bi bi-person-plus-fill"></i> Add</button>
                            <button type="button" class="btn btn-success btn-md" id="btn-product-update">Update</button>
                            <button type="button" class="btn btn-danger btn-md" id="btn-product-cancel"><i class="bi bi-person-x-fill"></i> Cancel</button>
                        </div>
                    </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        <thead class="thead-dark">
                                            <th>Description</th>
                                            <th>Amount of Purhase</th>
                                            <th>Date</th>
                                            <th class="text-center">Action</th>
                                        </thead>
                                        <tbody id="tbody-product">
                                            <tr>
                                                <td colspan="3" class="text-center">no data records found ...</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
