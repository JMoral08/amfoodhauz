...
<body class="app-body">
    <header class="app-header">
        ...
        <nav class="navbar-nav">
            <ul class="side-nav">
                <li class="nav-link">
                    <a class="nav-item position-relative" href="#"><i class="bi bi-bell"></i></a>
                </li>
                <li class="nav-link">
                    <a class="nav-item position-relative" href="#"><i class="bi bi-bookmark"></i></a>
                </li>
                <div class="vr"></div>
                <li class="nav-link dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <li><a class="dropdown-item" href="profile.php?id=<?php echo $id ?>"><i class="bi bi-person-circle"></i> Profile</a></li>
                        <li><a class="dropdown-item" href="#"><i class="bi bi-inboxes-fill"></i> Inbox</a></li>
                        <li><a class="dropdown-item" href="#"><i class="bi bi-credit-card"></i> Payments</a></li>
                        <li><a class="dropdown-item" href="#"><i class="bi bi-bank"></i> Banks</a></li>
    ...
    <aside class="app-sidebar">
        <ul class="sidebar">
            ...
            <li class="side-link">
                <a class="side-item" href="maintain.php"><i class="bi bi-tools"></i> Maintinance</a>
            </li>
            <li class="side-link">
        ...
        <div class="container-fluid mt-5">
            <div class="row">
                <div class="col-sm-12 col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="fw-bold text-uppercase"><span class="text-muted">Blank </span>Page</h4>
                        </div>
                    </div>
                </div>
            </div>
