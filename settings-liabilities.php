        ...
        <div class="container-fluid mt-5">
            <div class="row">
                <div class="col-sm-12 col-lg-12 mb-2">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="fw-bold text-uppercase m-auto"><span class="text-muted">liabilities</span> list</h4>
                    ...
                    <div class="card">
                        <div class="card-body row">
                            ...
                            <div class="col-sm-6 col-lg-6">
                                <p>Customer: <span id="lbl-customer" class="text-uppercase"></span></p>
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td colspan="2" class="text-end text-white bg-secondary">Subtotal</td>
                                                <td class="bg-success text-white" id="td-subtotal">.00</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
